// Imaging_C4+_extract_4points.cpp : イメージングリストデータからバックグラウンドを除去し、輝点が4点のもののみを抽出
//
...
{
	cout << "********************************************************************" << endl;
	cout << "****        Imaging C分解片個数解析プログラム for C4+           ****" << endl;
	cout << "****                  バックグラウンドを除去し、                ****" << endl;
	cout << "****         輝点が4つのもののみを抽出（連番処理）              ****" << endl;
	cout << "****                       ver.2020.1.20 written by R. Murase  ****" << endl;
	cout << "********************************************************************" << endl << endl;
	...
	cout << "\n出力するフォルダのパスを入力してください (\"@\"入力で同じフォルダ内の\"3_C4\"に保存)\n--->";
	cin >> outputFolderName;
	if (outputFolderName == "@")
	{
		outputFolderName = upperPath(inputDataFolder) + "\\3_C4";
	}
	...
	for (int m = start; m <= end; m++)
	{
		...
		cout << outputFilePath << "----データを読み込んでいます..." << endl;
