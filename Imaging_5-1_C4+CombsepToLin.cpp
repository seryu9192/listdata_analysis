// Imaging_5-1_C4+CombsepToLin.cpp : skewerNotationデータとコインシデンスしたImagingイベントを抽出
//
...
//SN_FOLDER(Triangle notation folder)
const string SN_FOLDER = "\\5_SkewerNotation\\5-1_Linear";
//outputfolderName
const string OUTPUT_FOLDER_NAME = "\\6_Linear";
...
int main(int argc, char* argv[])
{
	...
	//tnフォルダ
	string inputDataFolder_sn = upperFolder(inputDataFolder_img) + SN_FOLDER;
