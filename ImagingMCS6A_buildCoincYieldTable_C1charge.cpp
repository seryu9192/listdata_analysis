//ImagingMCS6A_buildCoincYieldTable_C1charge.cpp: あるTOFのピークとコインシデンスするprojectile価数を数え、coincYield(chn表記)
//                                          テーブルを作成する

//アップデートログ
//2020.10.13:ImagingMCS6A_buildCoincYieldTable_molAxisをもとに作成
...
//OUTPUT_DATANAME
string OUTPUT_DATANAME = "_coincYieldTable_charge.txt";
...
{
	cout << "*********************************************************************************" << endl;
	cout << "****              ImagingMCS6A_buildCoincYieldTable_charge.cpp               ****" << endl;
	cout << "****       -TOFピーク内のイベントとコインシデンスしている価数を数える-       ****" << endl;
	...
	cout << "****   imaging_center of mass:2(x), 3(y)列目, charge:5列目にあるとして評価   ****" << endl;
	...
	for (auto inputfilename_img : fNames)
	{
		...
		incidentCnt = inputListData_img.size();
...
{
	//読み取るべきパラメータのリスト
	vector<string> params = {"m/z", "roiMin", "roiMax", "E0", "imgFolder"};
